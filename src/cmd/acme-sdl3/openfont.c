/*
 * Local copy of libdraw/openfont.c.
 * The _fontpipe() function is provided by fontpipe.c (embedded fontsrv).
 * This file must be compiled as an explicit .o to prevent the linker
 * from pulling in libdraw's openfont.o (which defines a conflicting
 * _fontpipe that fork/execs fontsrv).
 */

/*
 * Local copy of libdraw/getsubfont.c.
 * Must be compiled as explicit .o to prevent linker from pulling
 * libdraw's getsubfont.o (which would conflict with our _fontpipe).
 */
...
int _fontpipe(char*);
int parsefontscale(char*, char**);

/* Embedded default font data */
#include "../../libdraw/defont.h"

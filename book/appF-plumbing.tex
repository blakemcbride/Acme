...
\cmd{open} on macOS, \cmd{explorer} on native Windows (which dispatches
through \cmd{ShellExecute}).  In the rules below, \texttt{OPENER}
represents the platform-appropriate command.
